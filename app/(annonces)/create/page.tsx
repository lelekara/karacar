...
import { Car, FileText, Settings, Euro, Calendar, Gauge, Fuel, Cog, Plus, ArrowLeft, Camera } from "lucide-react"
...
const CreateAnnoncePage: React.FC = () => {
  ...
  const onSubmit = async (data: AnnonceForm) => {
    ...
    router.push("/admin/dashboard") // Redirection vers le tableau de bord après la création
  }
        ...
        <div className="bg-gradient-to-r from-amber-800 to-red-900 rounded-xl p-8 text-white">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-amber-100 text-lg">Ajoutez un nouveau véhicule à votre catalogue</p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            ...
            <Card className="border-0 shadow-lg">
              <CardHeader>
                ...
                <CardDescription className="text-stone-600">
                  Spécifications techniques et détails du véhicule
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
            ...
            <Card className="border-0 shadow-lg">
              <CardHeader>
                ...
                <CardDescription className="text-stone-600">Définissez le prix de vente du véhicule</CardDescription>
              </CardHeader>
              <CardContent>
                <FormField
                  control={control}
            ...
            <Card className="border-0 shadow-lg border-dashed border-stone-300">
              <CardHeader>
                ...
                <CardDescription className="text-stone-600">Fonctionnalité à venir - Upload de photos</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="border-2 border-dashed border-stone-300 rounded-lg p-8 text-center">
                  <Camera className="w-12 h-12 text-stone-400 mx-auto mb-4" />
                  <p className="text-stone-500">Upload de photos - Fonctionnalité en développement</p>
                </div>
              </CardContent>
            </Card>
